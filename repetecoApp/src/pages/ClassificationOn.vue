         ...
         <div class="row container">
            <div class="btnNotification">
               ...
               <div class="btn-group pull-right btnclassifications" role="group" aria-label="...">
                  ...
                  <button type="button" class="btn btn-default active" v-tooltip.bottom-start="'Classificados'" onclick="location.href='classificationOn'" data-transition="slide"><i class="fa fa-star"> </i></button>
