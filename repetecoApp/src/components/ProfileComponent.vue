<template>
  <div>
    ...
    <div class="perfil profile-nav col-md-3">
        <div class="panel">
            ...
            <ul class="nav user-heading-ClassificationCout" v-show="flagDisplayCount === true">
                <li class="">
    ...
    <div class="panel perfil container panel col-md-9 perfilBG">
...
.user-heading-ClassificationCout{
    background: #d9edf7;
