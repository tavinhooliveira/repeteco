<template>
<li v-if="genderPreference === gender || gender === 'null' || gender === 'male' "  class="list-group-item col-md-4" v-bind:style="efeitoClick" v-on:mouseover="clickEfeito()" v-on:mouseout="removeClickEfeito()">
