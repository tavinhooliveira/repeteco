<template>
<li v-if="(genderPreference === gender || genderPreference === null) && statusOption != null" class="list-group-item col-md-4" v-bind:style="efeitoClick" v-on:mouseover="clickEfeito()" v-on:mouseout="removeClickEfeito()">
        ...
        <div class="col-md-8 classification">
            ...
            <div class="img_classification" > 
                ...
                <label class="cl_Ninteresse" title="Sem Interesse">
                    <input type="radio"  value="semInteresse" id="semInteresse" v-model="statusOption">
